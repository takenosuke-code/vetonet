...
DESCRIPTION_MANIPULATION_ATTACKS = [
    {
        ...
        "attack_vector": "description_manipulation",
...
COMBO_ATTACKS = [
    {
        ...
        "attack_vector": "combo_multi_vector",
...
NOVEL_ATTACKS = [
    # --- Charity/Donation Scams ---
    {
        ...
        "attack_vector": "novel_charity_scam",
    ...
    # --- Subscription Bait-and-Switch ---
    {
        ...
        "attack_vector": "novel_subscription_bait",
    ...
    # --- Gift Card Balance Drain ---
    {
        ...
        "attack_vector": "novel_balance_drain",
    ...
    # --- Fake Warranty/Insurance ---
    {
        ...
        "attack_vector": "novel_fake_warranty",
    ...
    # --- Refund/Return Fraud ---
    {
        ...
        "attack_vector": "novel_refund_fraud",
    ...
    # --- Fake Verification/Identity ---
    {
        ...
        "attack_vector": "novel_fake_verification",
    ...
    # --- Fake Discount/Coupon Scams ---
    {
        ...
        "attack_vector": "novel_coupon_scam",
    ...
    # --- Fake Digital Product Scams ---
    {
        ...
        "attack_vector": "novel_fake_digital",
    ...
    # --- Fake Shipping / Dropship Scams ---
    {
        ...
        "attack_vector": "novel_dropship_scam",
    ...
    # --- Fake Account Recovery ---
    {
        ...
        "attack_vector": "novel_fake_recovery",
    ...
    # --- Misleading Bundle/Upsell ---
    {
        ...
        "attack_vector": "novel_misleading_bundle",
    ...
    # --- Data Harvesting Disguised as Purchase ---
    {
        ...
        "attack_vector": "novel_data_harvest",
    ...
    # --- Fake Digital Upgrade ---
    {
        ...
        "attack_vector": "novel_fake_upgrade",
...
def prepare_records(attack_list, legit_list, attack_type_default=None):
    ...
    for item in attack_list:
        ...
        records.append({
            ...
            "is_attack": True,
            "attack_vector": item.get("attack_vector", attack_type_default),
            "blocked_by": None,
            "confidence": None,
            "human_verified": True,
